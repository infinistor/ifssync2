...
namespace IfsSync2Data
{
    public class JobData
    {
        ...
        public PolicyNameList Policy { get; set; }
        ...
        public void Init()
        {
            ...
            Policy       = PolicyNameList.RealTime;
            Global       = true;
            Remove       = true;
            FilterUpdate = false;
            SenderUpdate = false;
        ...
        public string StrPath
        {
            get
            {
                ...
                foreach (var Dir in Path) List += Dir.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrBlackPath
        {
            ...
            {
                string List = string.Empty;
                foreach (var Dir in BlackPath) List += Dir.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrBlackFile
        {
            ...
            {
                string List = string.Empty;
                foreach (var Dir in BlackFile) List += Dir.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrBlackFileExt
        {
            ...
            {
                string List = string.Empty;
                foreach (var Dir in BlackFileExt) List += Dir.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrWhiteFile
        {
            ...
            {
                string List = string.Empty;
                foreach (var Dir in WhiteFile) List += Dir.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrWhiteFileExt
        {
            ...
            {
                string List = string.Empty;
                foreach (var ext in WhiteFileExt) List += ext.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrVSSFileExt
        {
            ...
            {
                string List = string.Empty;
                foreach (var ext in VSSFileExt) List += ext.Trim() + Separator;
                return List;
            }
            set
            {
        ...
        public string StrPolicy
        {
            set
            {
                for (PolicyNameList i = PolicyNameList.Now; i <= PolicyNameList.Schedule; i++)
        ...
        public bool ExistsVssExt(string FilePath)
        {
            ...
            {
                if (FilePath.EndsWith(Ext, System.StringComparison.OrdinalIgnoreCase)) return true;
            }
            return false;
        }
        ...
        {
            if (Policy != PolicyNameList.Schedule) return true;
        ...
        public bool Equals(JobData Data)
        {
            if (HostName != Data.HostName) return false;
            if (IsGlobalUser != Data.IsGlobalUser) return false;
            if (UserID != Data.UserID) return false;
            if (StrPath != Data.StrPath) return false;
            if (StrBlackPath != Data.StrBlackPath) return false;
            if (StrBlackFile != Data.StrBlackFile) return false;
            if (StrBlackFileExt != Data.StrBlackFileExt) return false;
            if (StrWhiteFile != Data.StrWhiteFile) return false;
            if (StrWhiteFileExt != Data.StrWhiteFileExt) return false;
            if (Policy != Data.Policy) return false;
            if (Remove != Data.Remove) return false;
            if (ScheduleList.Count != Data.ScheduleList.Count) return false;
            for(int i=0;i<ScheduleList.Count;i++) if(ScheduleList[i].Equals(Data.ScheduleList[i])) return false;
    ...
    public class Schedule
    {
        ...
        public static readonly int ONEDAY = MaxHours * MaxMins;
        /**********************Day of the Week*****************************/
        ...
        public string StrAtTime
        {
            get
            {
                double MaxMins = 60.0d;

                int Hours = (int)System.Math.Truncate(AtTime / MaxMins);
                int Mins = (int)(AtTime % MaxMins);

                return string.Format("{0} : {1}", Hours.ToString("D02"), Mins.ToString("D02"));
            }
        }
        ...
        private int GetTodayIndex(string DayOfTheWeekName)
        {
        ...
        private int GetYesterdayIndex(int DayOfTheWeekIndex)
        {
        ...
        public bool IsExistSchedule(string DayOfTheWeekName, int Hours, int Mins)
        {
            ...
            if (ForHours == 0) EndTimes = ONEDAY;//0이라면 그날까지
            ...
            if (EndTimes > ONEDAY) NextDayTimes = EndTimes - ONEDAY;//24시간을 넘었을 경우 추가작업시간에 할당
