...
namespace IfsSync2Data
{
    ...
    static class Utility
    {
        ...
        public static void S3FileManagerStart(string URL, string AccessKey, string SecretKey)
        {
            string Source = "http://192.168.11.226:5544/IfsWeb/filemgr/s3.html";
            try
            {
                //Console.WriteLine("s3AuthURL={0}&accessKey={1}&accessSecret={2}", URL, AccessKey, SecretKey);

                //WebBrowser webBrowser = new WebBrowser();
                //webBrowser.Navigating += WebBrowser_Navigating;

                //string postData = string.Format("s3AuthURL={0}&accessKey={1}&accessSecret={2}", URL, AccessKey, SecretKey);
                //byte[] byteArray = Encoding.Default.GetBytes(postData);


                //webBrowser.Navigate(Source, "_blank", byteArray, "application/x-www-form-urlencoded");
            ...
            // Close the response.
            response.Close();
            //System.Diagnostics.Process.Start("http://192.168.11.226:5544/IfsWeb/filemgr/s3.html");
        }

        private static void WebBrowser_Navigating(object sender, System.Windows.Navigation.NavigatingCancelEventArgs e)
        {
